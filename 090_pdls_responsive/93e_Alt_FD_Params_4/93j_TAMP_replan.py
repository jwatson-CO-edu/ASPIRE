...
class ResponsiveExecutive:
    ...
    def phase_3_Plan_Task( self ):
        ...
        try:
            ...
            planner = 'progress1' #'ff-eager-pref' # 'add-random-lazy' # 'ff-eager-tiebreak' #'goal-lazy' #'ff-eager'
            solution = solve( 
                self.task, 
                ...
                complexity_step = 1,
                search_sample_ratio = 1/10, #1/1500, #1/5, #1/1000, #1/750 # 1/1000, #1/2000 #500, #1/2, # 1/500, #1/200, #1/10, #2, # 25 #1/25
